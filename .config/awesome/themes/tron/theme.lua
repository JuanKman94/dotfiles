...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/tron"
theme.wallpaper                                 = theme.dir .. "/wall.jpg"
theme.font                                      = "terminus 9"
theme.fg_normal                                 = cyan
theme.fg_focus                                  = cyan
theme.fg_urgent                                 = dark
theme.bg_normal                                 = dark
theme.bg_focus                                  = legacy
...
local spr_bg_color = legacy
local arrl_dl = separators.arrow_left(spr_bg_color, "alpha")
local arrl_ld = separators.arrow_left("alpha", spr_bg_color)
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            spr,
            arrl_ld,
            wibox.container.background(mpdicon, spr_bg_color),
            wibox.container.background(theme.mpd.widget, spr_bg_color),
            arrl_dl,
            volicon,
            theme.volume.widget,
            --arrl_ld,
            ...
            spr,
            arrl_ld,
            wibox.container.background(s.mylayoutbox, spr_bg_color),
        },
    }
end
