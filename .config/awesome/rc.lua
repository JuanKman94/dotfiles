...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Control", altkey }, "Left", function () lain.util.tag_view_nonempty(-1) end,
              {description = "view  previous nonempty", group = "tag"}),
    awful.key({ "Control", altkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
              {description = "view  previous nonempty", group = "tag"}),
    ...
    -- Widgets popups
    awful.key({ modkey, "Control" }, "c", function () lain.widget.calendar.show(7) end),
